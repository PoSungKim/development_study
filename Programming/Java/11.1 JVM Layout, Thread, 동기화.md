...
## 테스팅
#### Market (1) -> TicketStore (1) -> Tickets (n)

<br>

### Intrinsic Lock - Ticket
```java
...
<div align="center">
    <img width="50%" src="https://github.com/user-attachments/assets/f6e293c2-661d-4960-bc20-c28fac550404" />
</div>
* Customer.id = {2,1,3,4}가 Ticket.id = {1}에 Race Condition이 발생했다
* {2,1,3,4} 중 {2}가 Ticket.id = {1} 리소스를 선점하면서 해당 Ticket을 구매했다
