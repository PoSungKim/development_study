...
### Execution
* SQL Engine
  * retrieves data from disk into memory if the data is not in memory
  * takes out any locks and latches necessary to ensure data integrity
  * logs any changes made during the SQL execution
