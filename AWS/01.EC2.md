...
val stream = kd.writeStream.outputMode("append").format("console").start().awaitTermination()

val stream = kd.writeStream.outputMode("append").option("checkpointLocation","/Users/posungkim/Desktop/Portfolio/Big_Data_Platform/keypair")..start().awaitTermination()
