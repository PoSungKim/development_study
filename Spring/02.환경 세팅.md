...
* 주요 기능
  * Lifecycle Management
    * Build를 포함해서 개발 전 과정에 필요한 기능을 Automation 방식으로 수행해준다
  * Dependencies Management
    * 프로젝트를 개발하면서 필요한 다앙한 라이브러리들을 받아서 사용하는 과정을 관리해준다
...
spring.datasource.url=jdbc:mysql://[AWS 주소]:3306/pfm_mysql?allowPublicKeyRetrieval=true&useSSL=false
