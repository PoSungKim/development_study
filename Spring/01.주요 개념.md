...
<div align="center">
  ...
  <img width="607" alt="스크린샷 2021-05-08 오후 11 55 58" src="https://user-images.githubusercontent.com/37537227/117543721-f2ad8200-b058-11eb-9253-3b2afe3f48c5.png">

  ![스크린샷 2021-05-08 오후 9 03 21](https://user-images.githubusercontent.com/37537227/117538371-d3a2f600-b040-11eb-84f8-ec1bc6e86fe1.png)
...
#### ```TDD (Test-driven Development)```: 테스트 주도 개발로 에러를 미리 방지하기 위해서 단위 별로 검증하는 테스트 프레임워크
...
<div align="center">
   <img width="555" alt="스크린샷 2021-05-10 오후 10 49 02" src="https://user-images.githubusercontent.com/37537227/117669521-ee60a080-b1e1-11eb-891b-308e5ede19c3.png">
</div>
...
#### ```Controller Layer```는 요청에 따라 알맞는 비즈니스 로직이 시행되는 ```Service로 연결```해주는 역할
#### 이에 따라, ```Service Layer```는 ```Business Logic```에만 집중하는 가장 중요한 Layer
