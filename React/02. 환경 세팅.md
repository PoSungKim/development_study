...
```sh
yarn add -D webpack webpack-cli @types/webpack webpack-dev-server @types/webpack-dev-server babel-loader ts-node html-webpack-plugin css-loader mini-css-extract-plugin
