...
```js
yarn add -D webpack webpack-cli @types/webpack webpack-dev-server @types/webpack-dev-server babel-loader ts-node
...
#### 4. Node 환경에 Babel + Linting 구축 (.babelrc, .eslintrc.json)
...
#### 5. Webpack에 Type Checking 기능 넣기
